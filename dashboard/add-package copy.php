                                    ...
                                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab" aria-selected="false">
                                                <i class="fas fa-home"></i> Add Packages
                                            </a>
                                        </li>
...
$msg=$msg."Package Title Must Be More Than 5 Char Length.<BR>";
$status= "NOTOK";}


if ( strlen($package_price) < 2 ){
  $msg=$msg."Enter Price<BR>";
  $status= "NOTOK";}
   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" id="packageType" name="package_category">
            <?php
