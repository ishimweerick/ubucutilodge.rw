...
if($status=="OK")
{
$qb=mysqli_query($con,"INSERT INTO partner (ufile) VALUES ('$new_file_name')");
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <button type="submit" name="save" class="btn btn-primary">Upload Partner</button>
