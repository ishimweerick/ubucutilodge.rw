...
if($status=="OK")
{
$qb=mysqli_query($con,"update why_us set title='$title', detail='$detail' where id=$todo");
              ...
              <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="title"  value="<?php print $title ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Description</label>
                                                            <textarea class="form-control" name="detail" rows="3"><?php print $detail ?></textarea>
                                                        </div>
                                                    </div>   
