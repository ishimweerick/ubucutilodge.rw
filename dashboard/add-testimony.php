...
if($status=="OK")
{
$qf=mysqli_query($con,"INSERT INTO team (fullname, fb, ig, tw, position,image) VALUES ('$namex', '$fb', '$ig', '$tw', '$position', '$new_file_name')");
              ...
              <form action="" method="post" enctype="multipart/form-data">
                                              ...
                                              <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  name="fullname" placeholder="Enter Clients Name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  name="ig" placeholder="Enter Client's Position">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Facebook</label>
                                                            <input type="text" class="form-control"  name="fb" placeholder="Enter Client's Position">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Twitter</label>
                                                            <input type="text" class="form-control"  name="tw" placeholder="Enter Client's Position">
                                                        </div>
                                                    </div>
