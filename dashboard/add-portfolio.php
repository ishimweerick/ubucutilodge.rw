...
if($status=="OK")
{
$qb=mysqli_query($con,"INSERT INTO portfolio (ufile,destination) VALUES ('$new_file_name', '$destination')");
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                        ...
                                                        <input type="file" class="form-control" id="photoInput" name="ufile" onchange="previewImage(event)">
...
<script>
    function previewImage(event) {
        ...
        reader.onload = function() {
            ...
            output.innerHTML = '<img src="' + reader.result + '" class="img-thumbnail" style="max-width: 200px;">';
        }
