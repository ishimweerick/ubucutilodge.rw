...
$home_text = mysqli_real_escape_string($con,$_POST['home_text']);
...
$statistics_title = mysqli_real_escape_string($con,$_POST['statistics_title']);
$statistics_text = mysqli_real_escape_string($con,$_POST['statistics_text']);
...
if($status=="OK")
{
$qb=mysqli_query($con,"update section_title set home_title='$home_title', home_text='$home_text',about_title='$about_title', about_text='$about_text', why_title='$why_title',why_text='$why_text',service_title='$service_title',service_text='$service_text',port_title='$port_title',port_text='$port_text',test_title='$test_title',test_text='$test_text',contact_title='$contact_title',contact_text='$contact_text',enquiry_title='$enquiry_title',enquiry_text='$enquiry_text',statistics_title='$statistics_title',statistics_text='$statistics_text' where id=1");
...
while($row = mysqli_fetch_array($result))
{
  ...
  $statistics_title="$row[statistics_title]";
  $statistics_text="$row[statistics_text]";
}
  ?>
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
 ...
 <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Home Title</label>
                                                            <input type="text" class="form-control" id="firstnameInput" name="home_title"  value="<?php print $home_title ?>">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Home Text</label>
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="home_text" rows="2"><?php print $home_text ?></textarea>
                                                        </div>
                                                    </div>
   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Partners Text</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Statistics Title</label>
                                                            <input type="text" class="form-control" id="firstnameInput" name="statistics_title"  value="<?php print $statistics_title ?>">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Statistics Text</label>
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="statistics_text" rows="2"><?php print $statistics_text ?></textarea>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
