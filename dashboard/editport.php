...
if($status=="OK")
{
$qb=mysqli_query($con,"update portfolio set destination='$destination' where id='$todo'");
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="destination" value="<?php print $destination ?>" placeholder="Enter Portfolio Title">
                                                        </div>
                                                    </div>
